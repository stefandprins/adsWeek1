...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',  # More descriptive ID
                                                min=0,  # Minimum value
                                                max=10000,  # Maximum value
                                                step=1000,  # Step size
                                                marks={
                                                    0: '0 kg',  # Display 0 on the slider
                                                    2500: '2500 kg',  # Example mark at 2.5k
                                                    5000: '5000 kg',  # Example mark at 5k
                                                    7500: '7500 kg',  # Example mark at 7.5k
                                                    10000: '10000 kg',  # Display 10k on the slider
                                                },
...
def update_scatter(site, payload_range):
    ...
    if site == 'ALL':
        # Use the filtered DataFrame without additional site filtering
        fig = px.scatter(df_filtered, x='Payload Mass (kg)', y='class', 
                         color='Booster Version Category', 
                         title='Correlation between Payload and Success for all Sites')
    else:
        # Further filter the DataFrame based on the selected site and create the scatter plot
